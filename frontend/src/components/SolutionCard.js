...
import { Edit, Delete, GitHub as GitHubIcon } from '@mui/icons-material';
        ...
        >
            ...
            {isAdmin && (
                <Box sx={{ position: 'absolute', top: 8, right: 8, display: 'flex', gap: 1 }}>
                    <IconButton onClick={onEdit} aria-label="Edit problem" size="small">
                        <Edit fontSize="small" sx={{ color: '#ff6600' }} />
                    </IconButton>
                    <IconButton onClick={onDelete} aria-label="Delete problem" size="small">
                        <Delete fontSize="small" sx={{ color: '#ff6600' }} />
                    </IconButton>
                </Box>
            )}
        </motion.div>
