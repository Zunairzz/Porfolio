    ...
    return (
        <Base>
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-white to-orange-100">
                <div
                    className="bg-white/80 backdrop-blur-lg p-8 rounded-2xl shadow-xl w-full max-w-md border border-orange-400 transition-all duration-300 hover:shadow-orange-400/20" style={{marginTop:"100px"}}>
